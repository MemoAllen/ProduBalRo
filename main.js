...
const comandos = {
    // SALUDO
    "que tipo de quesos tienes": () => {
        voz("Tenemos una gran variedad, pero puede consultar todos nuestros productos en la sección de Productos");
    },

    "donde es su locación": () => {
        voz("Rancho la laja, Guanajuato, Celaya 94043, México");
    },

    "Como puedo comprar": () => {
        voz("Seleccione su producto preferido, y le aparecerá una venta, la cual contendra un apartado para su compra, el cual puede dar click y lo redireccionara a pago de paypal");
    },
    ...
    "quién te creo": () => {
        voz("El desarrollador Oscar Castañeda");
    },
